odoo.define('web.ContactInfo', function (require) {
"use strict";
...
var AbstractGroupedOne2ManyRenderer = ListRenderer.extend({
    ...
    */
    ...
    _renderTrashIcon: function() {
        return qweb.render('contact_trash_button');
    },
...
var ResumeLineRenderer = AbstractGroupedOne2ManyRenderer.extend({
    ...
    groupTitleTemplate: 'contact_group_rows',
    dataRowTemplate: 'contact_rows',
...
var ContactInfo = FieldOne2Many.extend({
...
field_registry.add('contact_info', ContactInfo);
