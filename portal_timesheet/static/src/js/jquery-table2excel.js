...
(function ( $, window, document, undefined ) {
    ...
    Plugin.prototype = {
        init: function () {
            ...
            $(e.element).each( function(i,o) {
                ...
                if(e.settings.exclude_buttons) {
                    tempRows = exclude_buttons(tempRows);
                }
    ...
    // Removes all buttons tags
    function exclude_buttons(string) {
        // var _patt = /(\s+class\s*=\s*"([^"]*)"|\s+class\s*=\s*'([^']*)')/i;
        // return string.replace(/<button[^>]*>/gi, function myFunction(x){
        //     var res = _patt.exec(x);
        //     if (res !== null && res.length >=2) {
        //         return res[2];
        //     } else {
        ...
        //     }
        // });
        // string.replace(/<button[^>]*><span>|<\/span><\/button>/gi, "");
        return string.replace(/<button[^>]*>|<\/button>/gi, "");
    }
