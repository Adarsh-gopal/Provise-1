...
class KsDashboardNinjaItems(models.Model):
    ...
    def ks_convert_into_proper_domain(self, ks_domain, rec):
        ...
        if ks_domain and "%MYREGION" in ks_domain:
            ks_domain = ks_domain.replace('"%MYREGION"', str(self.env.user.region2_ids.ids)).replace('=', 'in')
    ...
    def ks_convert_into_proper_domain_2(self, ks_domain_2, rec):
        ...
        if ks_domain_2 and "%MYREGION" in ks_domain_2:
            ks_domain_2 = ks_domain_2.replace('"%MYREGION"', str(self.env.user.region2_ids.ids)).replace('=', 'in')
        ...
        if self.ks_domain_2:
            ...
            try:
                ...
                if "%MYCOMPANY" in ks_domain_2:
                    ks_domain_2 = ks_domain_2.replace("%MYCOMPANY", str(self.env.user.company_id.id))
                if "%MYREGION" in ks_domain_2:
                    ks_domain_2 = ks_domain_2.replace('"%MYREGION"', str(self.env.user.region2_ids.ids)).replace('=',
                                                                                                                 'in')
