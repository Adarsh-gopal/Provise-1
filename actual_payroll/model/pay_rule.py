...
class HrSalaryRule(models.Model):
    ...
    condition_select_1 = fields.Selection([
    	...
    	], string="Condition Based on- Actual", default='none', required=True)
    condition_range_1 = fields.Char(string='Range Based on -Actual', default='contract.wage',
    	help='This will be used to compute the % fields values; in general it is on basic,'
    	'but you can also use categories code fields in lowercase as a variable names '
    	'(hra, ma, lta, etc.) and the variable basic.')
    condition_python_1 = fields.Text(string='Python Condition - Actual', required=True,
    	default='''
                    # Available variables:
                    #----------------------
    ...
    condition_range_min_1 = fields.Float(string='Minimum Range-Actual', help="The minimum amount, applied for this rule.")
    condition_range_max_1 = fields.Float(string='Maximum Range-Actual', help="The maximum amount, applied for this rule.")
    ...
    actual_fix = fields.Float(string='Fixed Amount - Actual',  digits='Payroll')
    actual_percentage = fields.Float(string='Percentage (%)- Actual', digits='Payroll Rate',
    	help='For example, enter 50.0 to apply a percentage of 50%')
    actual_python_compute = fields.Text(string='Python Code - Actual',
    	default='''
                    # Available variables:
                    #----------------------
                    # payslip: object containing the payslips
    ...
    actual_percentage_base = fields.Char(string='Percentage based on - Actual', help='result will be affected to a variable')   
